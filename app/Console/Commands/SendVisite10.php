...
class SendVisite10 extends Command
{
    protected $signature = 'visite10:send';
    ...
    public function handle()
    {
        try {
            ...
            $jumlah = $this->ambilDataVisite10($tanggal);

            $sendResponse = Http::withToken($accessToken)->post(env('IKT_VST_10'), [
                'tgl_transaksi' => $tanggal,
                'jumlah' => $jumlah,
            ]);

            if ($sendResponse->successful()) {
                Log::info('Visite 10 Data sent successfully.', [
                ...
                $this->line('Tanggal Transaksi : ' . $tanggal);
                $this->line('Jumlah Pasien Visite 10 : ' . $jumlah);
            }
    ...
    private function ambilDataVisite10($tanggal) {
