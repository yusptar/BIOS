...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style="font-weight:bold">Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri
                    </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Jumlah Satuan Presentase</label>
                            <input type="number" class="form-control" name="jumlah"
                                placeholder="Masukkan jumlah satuan presentase">
                        </div>
                    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>● Data dikirimkan per periode tahunan.</p>
      </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        $.ajax({
            url: "https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/ikt/pembelian_alkes_dalam_negeri",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('alat-kesehatan') }}"
                });
            },
            error: function(data) {
                console.log(data);
