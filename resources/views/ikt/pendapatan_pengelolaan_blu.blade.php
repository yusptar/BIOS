...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style="font-weight:bold">Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU
                    </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Presentase pertumbuhan pendapatan</label>
                            <input type="number" class="form-control" name="jumlah" placeholder="Masukkan presentase">
                        </div>
                    </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        $.ajax({
            url: "https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/ikt/pertumbuhan_realisasi_pendapatan_pengelolaan_aset_blu",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('aset-blu') }}"
                });
            },
            error: function(data) {
                console.log(data);
