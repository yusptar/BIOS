...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style="font-weight:bold">Kepatuhan Pelaksanaan Protokol Kesehatan</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Nilai Pelaksanaan Kepatuhan</label>
                            <input type="number" class="form-control" name="jumlah"
                                placeholder="Masukkan nilai pelaksanaan kepatuhan">
                        </div>
                    </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        $.ajax({
            url: "https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_pelaksanaan_prokes",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('protokol-kesehatan') }}"
                });
            },
            error: function(data) {
                console.log(data);
