...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style="font-weight:bold">Kepatuhan Waktu Visite Dokter</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
<div class="tab-pane fade show active" id="custom-tabs-five-overlay" role="tabpanel" aria-labelledby="custom-tabs-five-overlay-tab">
    <div class="overlay-wrapper" id="loading-overlay" style="display: none;">
        <div class="overlay">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('kepatuhan-wkt-visite-dokter') }}"
                });
            },
            error: function(data) {
                console.log(data);
