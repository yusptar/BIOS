...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0" style="font-weight:bold">Jumlah Visite Pasien Kurang Dari atau Sama Dengan Jam 10.00</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="jumlah"
                                placeholder="Masukkan jumlah visite pasien <= jam 10.00">
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('vst-psn-10') }}"
                });
            },
            error: function(data) {
                console.log(data);
