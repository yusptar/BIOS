...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight:bold">Saldo Rekening Operasional</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="no_rekening" placeholder="Masukkan no rekening">
                        </div>
                        <div class="form-group">
                            <label>Unit</label>
                            <input type="text" class="form-control" name="unit"
                                placeholder="Masukkan unit *contoh: nama fakultas, jika rekening milik BLU">
                        </div>
                        <div class="form-group">
                            <label>Saldo Akhir</label>
                            <input type="number" class="form-control" name="saldo_akhir"
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('sldo-rkn-ops') }}"
                });
            },
            error: function(data) {
                console.log(data);
