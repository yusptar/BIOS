...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight:bold">Jumlah Tenaga Professional Lainnya</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        $.ajax({
            url: "https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/sdm/profesional_lain",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
