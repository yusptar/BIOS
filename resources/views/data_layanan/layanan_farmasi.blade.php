...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight:bold">Jumlah Layanan Farmasi</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="jumlah" placeholder="Masukkan jumlah resep" disabled>
                        </div>
                    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>● Data yang dikirimkan merupakan resep yang dilayani oleh bagian farmasi atau resep yang masuk ke bagian farmasi baik dari luar maupun dari dalam Rumah Sakit.</p>
      </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        $.ajax({
            url: "https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/layanan/farmasi",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('lyn-farmasi') }}"
                });
            },
            error: function(data) {
                console.log(data);
