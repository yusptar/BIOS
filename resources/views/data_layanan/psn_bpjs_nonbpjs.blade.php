...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight:bold">Jumlah Pasien BPJS/Non BPJS (Dikirim Periode Harian)</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
...
$('#btn-submit').click(function() {
    if ($('#form-dokter-spesialis')[0].checkValidity()) {
        ...
        formData.append('jumlah_bpjs', $('input[name=jumlah_bpjs]').val());
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "{{ route('psn-bpjs-nonbpjs') }}"
                });
            },
            error: function(data) {
                console.log(data);
