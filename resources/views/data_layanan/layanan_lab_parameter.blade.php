...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-weight:bold">Jumlah Layanan Laboratorium (parameter)<br>(Dikirim Periode Harian)</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card card-default">
                ...
                <form id="form-dokter-spesialis">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Jumlah Layanan Lab Parameter</label>
                            <input type="number" class="form-control" name="jumlah"
                                placeholder="Masukkan jumlah layanan lab parameter" disabled>
                        </div>
                    </div>
